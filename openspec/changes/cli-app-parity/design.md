...
- 原子写：把 `AgentPanelShimProvisioner.ts:90-97` 的 EEXIST/EPERM rm+rename 重试提为 `src/shared/writeAtomic`（.mjs+.d.mts 同款共享），收敛 authSync、SystemCredentialSecretStore、TeamWorkspaceService、desktop/main 四处 rename 点。
