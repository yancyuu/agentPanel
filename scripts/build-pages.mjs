...
const DOWNLOADS = {
  macArm: {
    ...
    detail: 'Apple Silicon · DMG · 176 MB',
    filename: `AgentCLI-${DESKTOP_VERSION}-arm64.dmg`,
    href: `${RELEASE_BASE}/AgentCLI-${DESKTOP_VERSION}-arm64.dmg`,
    kind: 'desktop',
  },
  macIntel: {
    label: 'macOS Intel 独立包',
    shortLabel: 'macOS Intel',
    detail: 'Intel x64 · ZIP · 131 MB',
    filename: 'agentcli-macos-x64.zip',
    href: `${RELEASE_BASE}/agentcli-macos-x64.zip`,
    kind: 'portable',
  },
  windows: {
    label: 'Windows 独立包',
    shortLabel: 'Windows x64',
    detail: 'Windows x64 · ZIP · 123 MB',
    filename: 'agentcli-windows-x64.zip',
    href: `${RELEASE_BASE}/agentcli-windows-x64.zip`,
    kind: 'portable',
  },
  linux: {
    label: 'Linux 独立包',
    shortLabel: 'Linux x64',
    detail: 'Linux x64 · ZIP · 136 MB',
    filename: 'agentcli-linux-x64.zip',
    href: `${RELEASE_BASE}/agentcli-linux-x64.zip`,
    kind: 'portable',
  },
};
...
<body>
  ...
  <main id="top">
    ...
    <section id="download" class="download-section">
      <div class="download-inner">
        <div class="download-copy">
          ...
          <p>桌面客户端已内置 AgentCLI 与 cc-connect，不需要再通过 npm 安装。</p>
        </div>
        <div class="download-card">
          <div class="detected-label">已为你推荐</div>
          <h3 id="recommendedTitle">macOS 客户端</h3>
          <div id="recommendedDetail" class="download-detail">Apple Silicon · DMG · 176 MB</div>
    ...
    <section id="advanced" class="advanced">
      <details class="advanced-card">
        ...
        <div class="advanced-body">
          ...
          <p><strong>直接输入 <code>agentcli</code>：</strong>需要在客户端设置里启用一次“终端命令”，由客户端明确展示并完成 Shell PATH 集成；不会在你不知情的情况下修改 Shell 配置。</p>
    ...
    <section class="faq">
      ...
      <details><summary>安装 App 后是否还需要 Node.js 或 npm？</summary><p>不需要。桌面安装包包含运行 AgentCLI 所需的 Node 运行能力和 cc-connect。</p></details>
      <details><summary>为什么终端里暂时找不到 agentcli？</summary><p>App 内置 CLI 会先创建在 <code>~/.hermit/bin/agentcli</code>。为了不静默修改 Shell 配置，直接输入 <code>agentcli</code> 的 PATH 集成需要在客户端设置中明确启用一次。</p></details>
