...
describe('desktop runtime composition', () => {
  it('resolves packaged resources outside app.asar', () => {
    expect(
      resolveDesktopRuntimePaths({
        isPackaged: true,
        appPath: '/Applications/AgentPanel.app/Contents/Resources/app.asar',
        resourcesPath: '/Applications/AgentPanel.app/Contents/Resources',
      })
    ).toEqual({
      appRoot: '/Applications/AgentPanel.app/Contents/Resources/app.asar',
      runtimeRoot: '/Applications/AgentPanel.app/Contents/Resources/agentpanel',
      serverEntry: '/Applications/AgentPanel.app/Contents/Resources/agentpanel/dist/server.bundle.mjs',
      staticDir: '/Applications/AgentPanel.app/Contents/Resources/agentpanel/dist-renderer',
      cliEntry: '/Applications/AgentPanel.app/Contents/Resources/agentpanel/bin/agentpanel.mjs',
    });
  });
  ...
  it('forces the embedded server onto loopback and ignores ambient host/port values', () => {
    ...
    expect(environment).toMatchObject({
      ...
      AGENTPANEL_PACKAGE_ROOT: '/runtime',
      AGENTPANEL_DESKTOP_SESSION_TOKEN: 'secret-session',
